...
<c:import url="/WEB-INF/jsp/home/header.jsp" />
        ...
        <div class="modal-body">
            ...
            <form action="${pageContext.request.contextPath}/funcionario/cadastrar" method="post" class="form-group">
                ...
                <label>RG:</label><input type="text" class="form-control" id="rg" name="rg">
                ...
                <label>Nome de usuário:</label><input type="text" class="form-control" id="nomeusuario" name="nomeusuario">
                
                <label>Senha:</label><input type="password" class="form-control" id="senha" name="senha">

                <label>Funcão:</label><input type="text" class="form-control" id="funcao" name="funcao">
